...
const runMigrationsV2 = async () => {
    ...
    try {
        ...
        const migrationsDir = path.resolve(__dirname, '../../../migrations_v2');
        ...
        console.log(`🚀 Found ${files.length} migration scripts in v2. Running in sequential order...\n`);
        ...
        console.log(`\n🎉 All applicable v2 migrations executed successfully on [${config.target.toUpperCase()}] database!`);
        process.exit(0);
