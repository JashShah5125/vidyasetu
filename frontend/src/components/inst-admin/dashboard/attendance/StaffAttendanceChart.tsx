...
const StaffAttendanceChart: React.FC<StaffAttendanceChartProps> = ({
  data,
  loading,
}) => {
      ...
      <div className="border-b border-slate-100 pb-1 flex items-center justify-between">
        <div>
          <div className="flex items-center gap-1">
            <h4 className="font-bold text-slate-900 text-xs sm:text-sm leading-tight group-hover:text-emerald-950 transition-colors">
              Staff Attendance
            </h4>
            <ArrowUpRight
              size={12}
              className="text-slate-300 group-hover:text-emerald-600 opacity-0 group-hover:opacity-100 -translate-x-1 group-hover:translate-x-0 transition-all duration-200 shrink-0"
            />
          </div>
