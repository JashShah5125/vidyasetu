...
import { Plus, Eye, Edit3, Trash2, Search, Loader2, Copy, Check, MessageCircle, AlertTriangle, RotateCcw, Image, FileText, Video, Link as LinkIcon, Phone, ArrowLeft } from 'lucide-react';
