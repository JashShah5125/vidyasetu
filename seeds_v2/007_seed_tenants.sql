...
(2, 'Allen Career Institute', 'allen', 'ALLEN', 'customer', 'active',
 ...
 '["support@allen.ac.in", "billing@allen.ac.in"]'),
...
(4, 'FIITJEE', 'fiitjee', 'FIITJEE', 'customer', 'suspended',
 ...
 0.00, 199990.00, 18.00, 'INV-FIITJEE-001', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '["support@fiitjee.com"]'),
...
(6, 'Vibrant Academy', 'vibrant', 'VIBRANT', 'customer', 'active',
 ...
 5.00, 47490.50, 18.00, 'INV-VIBRANT-001', 10, 100, 5000, 10000, 200, '50 GB', '100 MB', 10000, 5000, '["it@vibrant.ac.in", "hr@vibrant.ac.in"]'),
...
(9, 'Unacademy', 'unacademy', 'UNACADEMY', 'customer', 'active',
 ...
 20.00, 159992.00, 18.00, 'INV-UNACADEMY-001', 200, 2000, 500000, 1000000, 5000, '5 TB', '1 GB', 500000, 250000, '["partners@unacademy.com", "legal@unacademy.com"]'),
...
(10, 'Vedantu', 'vedantu', 'VEDANTU', 'customer', 'suspended',
 ...
 0.00, 4999.00, 18.00, 'INV-VEDANTU-001', 20, 150, 20000, 40000, 500, '100 GB', '100 MB', 20000, 10000, '["contact@vedantu.com"]');
