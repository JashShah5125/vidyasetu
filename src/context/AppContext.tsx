...
interface AppContextType {
  ...
  addLead: (name: string, mobile: string, course: string, source: string, remarks: string) => void;
...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const addLead = (name: string, mobile: string, course: string, source: string, remarks: string) => {
    const newL: Lead = {
    ...
    logAction('CREATE_LEAD', `Logged new lead enquiry: ${name}`);
  };
