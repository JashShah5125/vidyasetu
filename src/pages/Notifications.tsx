...
export const Notifications: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h2 className="text-2xl font-display font-bold text-slate-900">Broadcast Notifications & Campaigns</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Select 
                  ...
                  options={[
                    ...
                    { value: 'branch-west', label: 'Mumbai West Branch Only' }
                  ]}
                />
                <Input 
        ...
        <div>
          <Card>
            <CardHeader>
              <CardTitle>Recent Dispatches Logs</CardTitle>
            </CardHeader>
            <div className="space-y-3 text-sm text-slate-600">
              <div className="p-3 bg-slate-50 border border-slate-100 rounded-lg space-y-1">
                <strong className="text-slate-800 text-xs block">Periodic chemistry marks published</strong>
                <p className="text-[11px] leading-relaxed">Evaluation sheets have been uploaded for NEET batch.</p>
                <span className="text-[9px] text-slate-400 font-bold block mt-1">Sent to: All Students</span>
              </div>
            </div>
          </Card>
        </div>
